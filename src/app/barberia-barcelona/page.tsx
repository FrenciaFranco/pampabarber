...
export const metadata: Metadata = {
  title: "Barberia y peluqueria en Barcelona",
  description:
    "PAMPA Barber es tu barberia y peluqueria en Barcelona para corte y barba con reserva online en Booksy.",
  keywords: [
    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      <section className="max-w-5xl mx-auto px-6 md:px-12 py-28 md:py-36">
        ...
        <h1 className="font-serif text-4xl md:text-6xl leading-tight tracking-tight mb-6">
          Barberia y peluqueria en Barcelona para corte y barba
        </h1>
        <p className="text-lg text-neutral-300 max-w-3xl leading-relaxed mb-10">
          Si buscas barberia en Barcelona con atencion al detalle, en PAMPA Barber trabajamos corte, barba y asesoria de estilo
          con reserva online. Estamos en Meridiana y cerca de la zona Ciutadella para quienes quieren una experiencia precisa,
          rapida y sin improvisaciones.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <article className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p className="text-neutral-300 leading-relaxed">
              Corte clasico, moderno y personalizado segun rostro, textura y estilo de vida. La idea es que salgas con un look
              limpio y facil de mantener.
            </p>
          </article>

          <article className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            <h2 className="font-serif text-2xl mb-3">Barba con precision</h2>
            <p className="text-neutral-300 leading-relaxed">
              Perfilado, volumen y simetria para una barba equilibrada. Trabajamos desde barba express hasta servicios completos
              de corte + barba.
            </p>
          </article>
        </div>
