...
export const metadata: Metadata = {
  title: "Barbería Meridiana y Ciutadella",
  description:
    "Barbería en Meridiana, Barcelona, cerca de Ciutadella. Servicio de peluquería, corte y barba con reserva online.",
  keywords: [
    "barberia meridiana",
    "barberia ciutadella",
    ...
    <main className="min-h-screen bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
      <section className="max-w-5xl mx-auto px-6 md:px-12 py-28 md:py-36">
        ...
        <h1 className="font-serif text-4xl md:text-6xl leading-tight tracking-tight mb-6">
          Barbería en Meridiana y cerca de Ciutadella
        </h1>
        <p className="text-lg text-neutral-600 dark:text-neutral-300 max-w-3xl leading-relaxed mb-10">
          Estamos en Avinguda Meridiana, Barcelona. Si te mueves por Ciutadella o alrededores, puedes reservar rápido en nuestra
          barbería y peluquería para corte, barba o packs de corte + barba con horario flexible.
        </p>
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-white/10 p-6 md:p-8 mb-10 bg-neutral-50 dark:bg-white/[0.03]">
          <h2 className="font-serif text-3xl mb-3">Dirección y reserva</h2>
        ...
        <div className="space-y-6">
          <article>
            <h2 className="font-serif text-2xl mb-2">Peluquería y barbería con enfoque técnico</h2>
            <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              Nuestro enfoque combina estética y técnica para que cada corte y barba encaje con tu perfil. Trabajamos para que
              el resultado se vea bien el primer día y también durante las semanas siguientes.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              Si vives o trabajas por Meridiana o te queda cómodo desde Ciutadella, puedes reservar online en segundos y venir
